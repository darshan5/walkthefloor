...
const navItems: NavItem[] = [
  { label: "Dashboard", href: "/", icon: LayoutDashboard },
  {
    ...
    children: [
      { label: "Book Dashboard", href: "/checklists" },
      { label: "Task Dashboard", href: "/checklists/tasks" },
      { label: "Daily Tasks", href: "/checklists/daily" },
      { label: "Task Progress", href: "/checklists/progress" },
      { label: "Adherence", href: "/checklists/adherence" },
      { label: "Compliance", href: "/checklists/compliance" },
      { label: "Corrective Actions", href: "/checklists/corrective-actions" },
      { label: "Temperature", href: "/checklists/temperature" },
      { label: "Reports", href: "/checklists/reports" },
      { label: "Templates", href: "/checklists/templates" },
    ],
  },
  { label: "Audits", href: "/audits", icon: ListChecks, permission: "audits" },
